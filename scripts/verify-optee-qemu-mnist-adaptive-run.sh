...
check_log_ordered "TEAR: reported_decision model_id=mnist-onnx-v1 proposal=request_high_accuracy_profile decision=rejected reason=profile_unavailable value=0"
